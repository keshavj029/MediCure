...
const EditAppointmentModal = ({
  ...
  return (
    <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full bg-opacity-10 backdrop-blur-xs">
      <div className="w-full max-w-md p-6 bg-gray-800 rounded-lg shadow-lg bg-opacity-20 backdrop-blur-3xl ">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            readOnly 
            className="block w-full p-2 mt-1 border-b-4 border-blue-600 rounded-md shadow-sm focus:outline-none focus:border-indigo-700"
          />
        </div>
        <div className="mb-4">
          <label className="block text-sm font-medium text-blue-700">
          ...
          <input
            ...
            className="block w-full p-2 mt-1 border rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:ring-opacity-50"
          />
        </div>
